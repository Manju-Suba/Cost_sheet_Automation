                                        ...
                                        <div class="col">
                                            <div class="my-4 text-center">
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-bs-toggle="modal" data-bs-target="#uomModal">Add
                                                    Location</button>
                                            </div>
                                                        ...
                                                        <div class="modal-body">
                                                            <form id="frm_uom" enctype="multipart/form-data">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label for="pname" class="form-label">Location
                                                                            Name</label>
                                                                        <input type="text" class="form-control"
                                                                            id="lname" name="location_name">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input type="text" class="form-control uname_class"
                                                                            id="edit_lname" name="edit_location_name">
                                                                            <span class="location-error text-danger" ></span>
                                                                        <input type="hidden" name="_token"
                                                                            value="<?= csrf_token() ?>">
                                                                    </div>
    ...
    <script>
        ...
        $('#save_id').click(function(){
            ...
            $.ajax({
             ...
             $(".location-error").html('Location field is required')
            }
        ...
        function edit_form(id){
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    $('.uname_class').val(data.data.location_name);
                }
            });
        }
