                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <h4 class="card-title">RM Scarp</h4>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="table-responsive">
                                                                        <table class="table table-hover " id="rm_scrap">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th>S.no</th>
                                                                                    <th>Product Name</th>
                                                            ...
                                                            <div class="modal-dialog modal-lg">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="staticBackdropLabel">View RM Scrap with Approval Process</h5>
                                                                        ...
                                                                        <div class="col-12">
                                                                            ...
                                                                            <div class="row mt-3 mb-1">
                                                                                ...
                                                                                <div class="col-md-3">
                                                                                    ...
                                                                                    <button type="button" class="btn btn-success" onclick="scrap_approve()">RM Scrap Approve</button>
                                                                                </div>
                                                                                <div class="col-md-3">
                                                                                    <button type="button" class="btn btn-danger" onclick="scrap_reject()">RM Scrap Reject</button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
