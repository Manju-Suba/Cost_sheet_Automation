...
<body data-layout="detached" data-topbar="colored">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <h4 class="card-title">Existing Product - Primary & Secondary Freight Details</h4>
                                        <p class="card-title-desc"></p>

                                        <div class="table-responsive">
                                            <table class="table table-hover " id="freight_shown">
                                                <thead>
                                                    <tr>
                                                        <th>S.no</th>
                                                        <th>Material Code</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            table = $('#freight_shown').DataTable({
                "autoWidth": false,
                'ajax': {
                    url: "{{ url('get_exists_freight')}}",
                    // type: 'POST'
                },
                columns: [
                    {data: 'DT_RowIndex'},
                    ...
                    {data: 'prim_Location', name: 'prim_Location'},
                    {data: 'prim_freight', name: 'prim_freight'},
                    {data: 'sec_location', name: 'sec_location'},
                    {data: 'sec_freight', name: 'sec_freight'},
