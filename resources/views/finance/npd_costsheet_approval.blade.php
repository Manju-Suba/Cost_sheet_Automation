                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <h4 class="card-title">NPD Cost Sheet Approval</h4>
                                        ...
                                        <div class="tab-content p-3 text-muted">
                                                                ...
                                                                <div class="row">
                                                                    <div class="table-responsive">
                                                                        <table class="table table-hover "
                                                                            id="costsheet_tb" style="width:100%">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th>S.no</th>
                                                                                    {{-- <th>Versions No</th> --}}
                                            ...
                                            <div class="tab-pane" id="profile1" role="tabpanel">
                                                <div class="col-12">
                                                    <div class="table-responsive">
                                                        <table class="table table-hover" id="csheet_approved_tb"
                                                            style="width: 100%;">
                                                            <thead>
                                                                <tr>
                                                                    <th>S.no</th>
                                            ...
                                            <div class="tab-pane" id="messages1" role="tabpanel">
                                                <div class="col-12">
                                                    <div class="table-responsive">
                                                        <table class="table table-hover " id="rejected_tb"
                                                            style="width:100%">
                                                            <thead>
                                                                <tr>
                                                                    <th>S.no</th>
