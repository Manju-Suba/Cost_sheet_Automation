...
@endif
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mt-3">
                                            <button class="btn btn-success w-100 waves-effect waves-light"  type="submit" value="Register">Register</button>
                                        </div>
                                        ...
                                        <div class="mt-4 text-center">
                                            <p class="mb-0">Already have an account ? <a href="logout" class="fw-medium text-primary"> Login</a></p>
                                        </div>
                                        @csrf
                                    </form>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center p-4">
                            <p>© <script>document.write(new Date().getFullYear())</script> webadmin. Crafted with <i class="mdi mdi-heart text-danger"></i> by HEPL</p>
                        </div>
                    </div>
                </div>
